...
## Action  
<div  style="border:1px solid #BBB"><table><tr><td rowspan="2" style="width:200px;text-align:center;font-size:1.3em;font-weight:bold"><div style="padding:5px;border:1px dashed #333"><div>Good!</div></div></td><td></td></tr><tr><td><b>Self：</b>→Dismiss</td></tr><tr><td colspan="2">[<div style="width:25px;display:inline-block;text-align:center"><img decoding="async" src="../wiki/Sprite/GranfatherHealthy.png" href="a.md" style="max-width:25px;max-height:25px;"></div>[Grandpa has recovered!(Event)](Event_OutroFarmer2.md)](Event_OutroFarmer2.md)(<span style="font-family:ui-monospace"><b>+1</b></span>)</td></tr></table></div>  
