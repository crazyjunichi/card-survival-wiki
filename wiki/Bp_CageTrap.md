...
> 非常适合用来活捉中小型动物。  
  ...
  诱捕笼  |   图片   
 ----  |  ----:   
 ** 解锁条件: **<br>[陷阱(技能)](Skill_Trapping.md): 70-150<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制造动作](CraftAction.md)  |  <img decoding="async" src="Sprite/CageShut.png" href="a.md" style="max-width:300px;max-height:300px;">   
