...
[斧头模具](MoldAxe.md)  |  熔炼斧子头  |  6小时  |  ** 需要属性：**<br>温度<img decoding="async" src="Sprite/Hot.png" href="a.md" style="max-width:20px;max-height:20px;">: 1100～3000  |  [斧子头](AxeHead.md)(+1)  |  [金工(技能)](Skill_Metalworking.md)+2  
[刀模具](MoldKnife.md)  |  熔炼铜刀  |  6小时  |  ** 需要属性：**<br>温度<img decoding="async" src="Sprite/Hot.png" href="a.md" style="max-width:20px;max-height:20px;">: 1100～3000  |  [铜刀](KnifeCopper.md)(+1)  |    
[铲头模具](MoldShovel.md)  |  熔炼铲子头  |  6小时  |  ** 需要属性：**<br>温度<img decoding="async" src="Sprite/Hot.png" href="a.md" style="max-width:20px;max-height:20px;">: 1100～3000  |  [铲子头](ShovelHead.md)(+1)  |    
[矛头模具](MoldSpear.md)  |  熔炼矛头  |  6小时  |  ** 需要属性：**<br>温度<img decoding="async" src="Sprite/Hot.png" href="a.md" style="max-width:20px;max-height:20px;">: 1100～3000  |  [矛头](SpearHead.md)(+1)  |    
