...
撤退<br>  |  15分  |    |  ** 自身：**<br>→消失<br><br>** 获得： **<br>** [Success] **<br>基础权重：50<li>[潜行(技能)](Skill_Stealth.md)为1～150时权重+1～+250</li><li>[盾牌](Shield.md)存在于*手中/装备*，权重+100</li><li>[忠犬朋友](DogFriend.md)存在，权重+100</li><br>** [Failure] **<br>  [那条眼镜蛇喷射了毒液！(事件)](Event_CobraFightFailedRetreat.md)(+1)<br>基础权重：50  |  [潜行(技能)](Skill_Stealth.md)+1  
