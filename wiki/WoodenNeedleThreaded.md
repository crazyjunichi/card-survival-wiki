...
> 用于制作更复杂的纺织品或者皮制品。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**10<br><br>**标签：**	[“针线”](tag_ThreadedNeedle.md)<br><br>**可使用次数：**3  |  ![](Sprite/ThreadedNeedleWood.png)   
...
动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
取下细线  |  -  |  [光亮](Light.md):10-100  |  → [木针](WoodenNeedle.md)<br><br>[细线](CordFiber.md)(+1)  |    
## 可拖至  
...
<img decoding="async" src="Sprite/Durability.png" style="width:30px;">  |  初始：3<br>最大：3  |  -  |    
  |  初始：1<br>最大：1  |  -  |  → [木针](WoodenNeedle.md)  
