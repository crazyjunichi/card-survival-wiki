...
> 一种用煮过的<b>参薯、糖、椰奶和油或脂肪</b>制成的美味而浓郁的果酱。<br><br>它能保存很长一段时间，可以涂在西米饼上作为美味的早餐。  
  ...
  参薯酱  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“饲料”](tag_Feed.md), [“肉”](tag_Meat.md), [“人类食物”](tag_HumanFood.md)<br><br>**可使用次数：**3  |  <img decoding="async" src="Sprite/YamJam.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
使用次数  |  初始：3<br>最大：3  |  -  |  ** 到达0时： **<br><br>** 自身 **<br>→消失  
