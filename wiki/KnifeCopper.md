...
>   
  ...
  铜刀  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“刮具”](tag_Scraper.md), [“切割工具”](tag_Cutter.md), [“高级切割工具”](tag_CutterAdv.md), [“锤”](tag_Hammer.md), [“沉重的”](tag_Heavy.md), [“美丽的/好看的”](tag_Pretty.md), [“铜制小物件”](tag_CopperSmall.md)<br><br>**可使用次数：**40  |  <img decoding="async" src="Sprite/CopperKnife.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[刀模具](MoldKnife.md) , [熔炉](Forge.md)  |  刀  
[刀模具](MoldKnife.md) , [高级窑炉](KilnAdvanced.md)  |  熔炼铜刀  
[铜刀](KnifeCopper.md)  |  磨利<br>** 拖入：**[石头](Stone.md)  
[钝刀](KnifeCopperBlunt.md)  |  磨利<br>** 拖入：**[石头](Stone.md) , [大石块](StoneHeavy.md)  
## 可拖入  
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[石头](Stone.md)  |  磨利<br>[手部动作](HandAction.md)  |  30分  |    |  ** 自身: **<br>→ [铜刀](KnifeCopper.md)<br><br>** 使用物: **<br>可用次数  -1  |    
## 可拖至  
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：40  |  -  |  ** 到达0时： **<br><br>** 自身 **<br>→ [钝刀](KnifeCopperBlunt.md)  
