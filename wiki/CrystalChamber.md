...
> 一个洞穴，洞壁上覆盖着某种水晶状的矿物。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **标签：**	[“室内”](tag_EnvIndoors.md), [“洞穴系统”](tag_EnvCaveSystem.md)<br><br>** 只允许存在一个 **  |  ![](Sprite/CrystalChamber.png)   
  
## 探索  
进度  |  目的地  
----  |  ----  
50%  |  [铜矿脉(狭窄隧道)](CopperVein.md)  
100%  |  [狭窄通道(晶石洞穴)](FloodedChamberEntranceClosed.md)  
## 动作  
动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
探索<br>  |  15分  |  [光亮](Light.md):5-100  |  [石头](Stone.md)(+1)<br>基础权重：10<br><br>[方解石晶体](Calcite.md)(+1)<br>基础权重：1<br><br>[晶洞](Geode.md)(+1)<br>基础权重：5<br>  |  [污垢](Filth.md)+2  
## 可拖入  
使用  |  动作  |  时间  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
