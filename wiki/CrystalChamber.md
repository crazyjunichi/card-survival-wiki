...
> 一个洞穴，洞壁上覆盖着某种水晶状的矿物。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **标签：**	[“室内”](tag_EnvIndoors.md), [“洞穴系统”](tag_EnvCaveSystem.md)  |  ![](Sprite/CrystalChamber.png)   
...
动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
探索  |  15分  |  [光亮](Light.md):5-100  |  [石头](Stone.md)(1)<br>[方解石晶体](Calcite.md)(1)<br>[晶洞](Geode.md)(1)  |  [污垢](Filth.md)+2  
## 可拖入  
使用  |  动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
