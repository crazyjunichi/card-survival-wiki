...
> 如果在你附近有<b>飞机或船</b>的残骸，你可以从中回收一些<b>废金属</b>，用它们来做一把金属矛。<br><br>将回收来的金属用<b>细线和绳子</b>绑在<b>长木棍</b>的末端，这样你就有了一把优秀耐用的狩猎、自卫用武器。  
  ...
  废金属长矛  |   图片   
 ----  |  ----:   
 ** 装备时等效于拿在手上 **<br><br>**重量：**250<br><br>**装备时减重：**-200<br><br>**标签：**	[“一级矛”](tag_Spear.md), [“大的”](tag_Large.md)<br><br>**装备：**[“肩部装备”](eTag_Shoulder.md)<br><br>**可使用次数：**120  |  <img decoding="async" src="Sprite/SpearScrap.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：120  |  -  |  ** 到达0时：长矛坏了 **<br>** [Spear Head] **<br>  [绳子](Rope.md)(+1)<br>  [小树枝](Sticks.md)(+2)<br><br>** 自身 **<br>→消失  
