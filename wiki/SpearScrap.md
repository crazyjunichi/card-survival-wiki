...
> 一柄优秀的狩猎工具。  
  ...
  废金属长矛  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“一级矛”](tag_Spear.md), [“大的”](tag_Large.md)<br><br>**装备：**[“肩部装备”](eTag_Shoulder.md)<br><br>**可使用次数：**120  |  ![](Sprite/SpearScrap.png)   
...
拆解<br>[手部动作](HandAction.md)  |  15分  |    |  消失<br>使用次数  -1<br>[长木棍](StickLong.md)(+1)<br>[绳子](Rope.md)(+1)<br>  |    
## 可拖至  
