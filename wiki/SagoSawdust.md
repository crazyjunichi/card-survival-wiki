...
>   
  ...
  西米树芯  |   图片   
 ----  |  ----:   
 **重量：**25<br><br>**标签：**	[“饲料”](tag_Feed.md)  |  <img decoding="async" src="Sprite/CoconutGround.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[劈开的西米树干](SagoSplitLog.md)  |  刮取树芯<br>** 拖入：**[“切割工具”](tag_Cutter.md) , [“斧”](tag_Axe.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
...
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[“灌溉用水”](tag_WaterFresh.md)  |  浸泡<br>  |  -  |    |  ** 自身: **<br>→消失<br><br>** 使用物: **<br>→ [浸泡的西米](LQ_SoakedSago.md)  |    
## 可拖至  
