...
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
拔掉刺<br>  |  15分  |    |  <img decoding="async" src="Sprite/UrchinSpines.png" href="a.md" style="max-width:20px;max-height:20px;">  -4  |  [情绪](Morale.md)-10  
## 属性   
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
...
Urchin Wound  |  ** 需要属性：**<br><img decoding="async" src="Sprite/Health.png" href="a.md" style="max-width:20px;max-height:20px;">: 0～250  |    |  [疼痛](Pain.md)+300<br>[皮肤完整度](SkinIntegrity.md)-1<br>[ModifierLeg_GameName](ModifierLeg.md)+3<br>[体重](Weight.md)加成-0.1<br>[受伤](Wounds.md)+100  
