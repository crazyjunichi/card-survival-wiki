...
>   
  ...
  塑料瓶  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“容器（密封）”](tag_ContainerSealed.md)<br><br>**容水量：**300  |  <img decoding="async" src="Sprite/PlasticBottleDirty.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[茉莉花](JasmineFlowers.md)  |  插花  |  -  |    |  ** 自身: **<br>→ [茉莉花(塑料瓶)](PlasticBottleJasmine.md)<br>** 使用物: **<br>消失  |    
## 可拖至  
