...
> 结实到可以盛放酸液的密闭容器。  
  ...
  釉面陶罐  |   图片   
 ----  |  ----:   
 ** 解锁需求: **<br>[陶罐](ClayVase.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制陶动作(大)](PotteryActionMajor.md)  |  <img decoding="async" src="Sprite/GlazedVase.png" href="a.md" style="max-width:300px;max-height:300px;">   
