...
> 一个漂亮的金属瓶，烧水更快。<br><br><b>可在装备栏装备</b>  
  ...
  铜瓶  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**装备时减重：**-100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“挎包”](tag_Satchel.md), [“容器（密封）”](tag_ContainerSealed.md), [“金属容器”](tag_ContainerMetal.md), [“装饰品”](tag_Decoration.md), [“铜制大物件”](tag_CopperBig.md)<br><br>**装备：**[“肩部装备”](eTag_Shoulder.md)<br><br>**储水量：**600  |  <img decoding="async" src="Sprite/CopperBottle.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[铜瓶(蓝图)](Bp_CopperBottle.md)  |  蓝图制造  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
