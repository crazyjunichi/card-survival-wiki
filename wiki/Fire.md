...
[木炭](Charcoal.md)<br>[火炭](Embers.md)  |  添入木炭<br>  |  -  |    |  ** 自身: **<br>燃料  +7(10.94%)<br><img decoding="async" src="Sprite/Charcoal.png" href="a.md" style="max-width:20px;max-height:20px;">  +7(43.75%)<br><br>** 使用物: **<br>→消失  |    
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
燃料  |  初始：32<br>最大：64  |  每15分钟-1<br>最多需要：16小时  |  ** 到达0时： **<br>** [1]  **<br>  [灰烬](Ash.md)(+1)<br>基础权重：1<br>** 自身 **<br>→消失  
