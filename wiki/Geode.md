...
>   
  ...
  晶洞  |   图片   
 ----  |  ----:   
 ** 不可删除 **<br><br>**重量：**750<br><br>**标签：**	[“锤”](tag_Hammer.md)  |  <img decoding="async" src="Sprite/Geode.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[“锤”](tag_Hammer.md)  |  敲开<br>[手部动作](HandAction.md)  |  1小时  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>→消失<br><br>** 使用物: **<br>可用次数  -2<br><br>** 获得: **<br>** [Stone] **<br>  [石头](Stone.md)(+1)<br>基础权重：55<br>** [Calcite] **<br>  [方解石晶体](Calcite.md)(+1)<br>基础权重：40<br>** [Malachite] **<br>  [铜矿石](CopperOre.md)(+1)<br>基础权重：10  |  [手掌损伤](HandDamage.md)+15  
## 可拖至  
