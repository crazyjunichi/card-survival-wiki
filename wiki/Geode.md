...
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[“锤”](tag_Hammer.md)  |  敲开  |  1小时  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>消失<br>** 使用物: **<br>可用次数  -2<br>** 获得: **<br>[石头](Stone.md)(+1)<br>基础权重：55<br><br>[方解石晶体](Calcite.md)(+1)<br>基础权重：40<br><br>[铜矿石](CopperOre.md)(+1)<br>基础权重：10<br>  |  [手掌损伤](HandDamage.md)+15  
## 可拖至  
