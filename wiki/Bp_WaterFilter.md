...
> 能净化不安全的水。  
  ...
  滤水器  |   图片   
 ----  |  ----:   
 ** 解锁需求: **<br>[火炉(熄灭)](StoveExtinguished.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)  |  <img decoding="async" src="Sprite/WaterFilter.png" href="a.md" style="max-width:300px;max-height:300px;">   
