...
捆起来<br>[手部动作](HandAction.md)  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身：**<br>→ [哺乳期山羊](GoatTiedFemaleLactating.md)<br>压力<img decoding="async" src="Sprite/Content.png" href="a.md" style="max-width:20px;max-height:20px;">  -250  |    
...
[“储水容器”](tag_WaterContainer.md)  |  挤奶<br>[手部动作](HandAction.md)  |  -  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>奶量<img decoding="async" src="Sprite/Milk.png" href="a.md" style="max-width:20px;max-height:20px;">  -48<br><br>** 使用物: **<br>可用次数  -1<br><br>[全脂羊奶](LQ_MilkWhole.md)(+150)  |  [污垢](Filth.md)+5  
## 属性   
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
