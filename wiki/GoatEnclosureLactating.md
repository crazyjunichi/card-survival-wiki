...
[“储水容器”](tag_WaterContainer.md)  |  挤奶  |  -  |  [光亮](Light.md): 10-100  |  自身:<br>→ [山羊尸体(母)](GoatCarcassFemale.md)<br>奶量<img decoding="async" src="Sprite/Milk.png" style="width:20px;">  -48<br><br>使用物:<br>可用次数  -1<br><br>  |  [污垢](Filth.md)+5  
## 属性   
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
