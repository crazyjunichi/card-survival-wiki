...
来源  |  操作  
----  |  ----  
[未栽种的农田(空)](CropPlotEmpty.md)  |  种植香蕉树<br>** 拖入：**[香蕉](Banana.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
...
成熟度  |  初始：0<br>最大：672  |  每15分钟+0.5<br>最多需要：14天  |  ** 到达上限时： **<br>** [Result] **<br>  [香蕉树](BananaTree.md)(+2)<br><br>** 自身 **<br>→消失  
...
Humid  |  ** 需要存在卡牌：**<br>[“潮湿环境”](tag_EnvHumid.md)  |  真菌感染<img decoding="async" src="Sprite/SaturationMushrooms.png" href="a.md" style="max-width:20px;max-height:20px;"> +0.25(0.08%)<br>成熟度+0.25(0.03%)  |    
...
<script>document.title="香蕉树田 - 卡牌生存百科 Card Survival Wiki";</script>