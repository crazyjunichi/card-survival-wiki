...
> 可以用来砍树，斧刃钝了的话就得再打磨一下。  
  ...
  求生斧  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“锤”](tag_Hammer.md), [“斧”](tag_Axe.md), [“高级斧”](tag_AxeAdv.md), [“沉重的”](tag_Heavy.md)<br><br>**可使用次数：**50  |  <img decoding="async" src="Sprite/SurvivalAxe.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[求生斧](AxeSurvival.md)  |  磨利<br>** 拖入：**[石头](Stone.md)  
[钝的求生斧](AxeSurvivalBlunt.md)  |  磨利<br>** 拖入：**[石头](Stone.md) , [大石块](StoneHeavy.md)  
## 可拖入  
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[石头](Stone.md)  |  磨利<br>  |  30分  |    |  ** 自身: **<br>→ [求生斧](AxeSurvival.md)<br><br>** 使用物: **<br>可用次数  -1  |    
## 可拖至  
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：50<br>最大：50  |  -  |  ** 到达0时： **<br><br>** 自身 **<br>→ [钝的求生斧](AxeSurvivalBlunt.md)  
