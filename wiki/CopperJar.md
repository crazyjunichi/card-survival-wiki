...
> 一个密封的小容器。也可以用作装饰品  
  ...
  铜罐  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“粘土”](tag_Clay.md), [“可烹饪的”](tag_Cookable.md), [“容器（密封）”](tag_ContainerSealed.md), [“金属容器”](tag_ContainerMetal.md), [“可泼溅的”](tag_Spillable.md), [“美丽的/好看的”](tag_Pretty.md), [“装饰品”](tag_Decoration.md), [“铜制小物件”](tag_CopperSmall.md)<br><br>**储水量：**150  |  <img decoding="async" src="Sprite/CopperJar.png" href="a.md" style="max-width:300px;max-height:300px;">   
