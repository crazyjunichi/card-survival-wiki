...
>   
  ...
  马勃菌  |   图片   
 ----  |  ----:   
 **重量：**75<br><br>**标签：**	[“杂食饲料”](tag_FeedOmnivorous.md), [“喂食（草食动物）”](tag_FeedHerb.md), [“喂/添加”](tag_Feed.md), [“人类食物”](tag_HumanFood.md)  |  <img decoding="async" src="Sprite/Puffballs.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
食用<br>[食用蔬菜类动作](VegetarianAction.md)<br>[进食动作](EatingAction.md)  |  15分  |    |  消失  |  [饱食](Satiation.md)+25<br>[胃](Stomach.md)+8<br>[水分](Hydration.md)+2<br>[情绪](Morale.md)+1<br>[蘑菇<nobr>厌倦度</nobr>](SaturationMushrooms.md)+30  
## 可拖至  
