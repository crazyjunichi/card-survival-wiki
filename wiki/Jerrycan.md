...
>   
  ...
  油桶  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“大的”](tag_Large.md), [“容器（密封）”](tag_ContainerSealed.md), [“沉重的”](tag_Heavy.md)<br><br>**容水量：**2400  |  <img decoding="async" src="Sprite/Jerrycan.png" href="a.md" style="max-width:300px;max-height:300px;">   
