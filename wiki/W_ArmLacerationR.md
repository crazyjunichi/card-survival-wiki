...
> 一道正在流血的深撕裂伤口，好痛……  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**0<br><br>**标签：**	[“开放性伤口”](tag_OpenWound.md)<br><br>**装备：**[“右臂撕裂伤”](eTag_WArmLacerationR.md)<br><br>**槽位：**1<br><br>**过滤器：**[“敷料”](tag_Dressing.md) , [“止血带”](tag_Tourniquet.md)<br><br>**可使用次数：**0  |  ![](Sprite/ArmLaceration.png)   
...
[“针线”](tag_ThreadedNeedle.md)  |  缝合  |  15分  |  [光亮](Light.md):10-100<br>[勇气](Courage.md):800-4000  |  自身:<br>→ [已缝合的右臂撕裂伤](W_ArmLacerationRStitched.md)<br>可用次数 + 8<br>燃料  -350<br><br>使用物:<br>可用次数  -1<br><br>  |    
## 转化  
放入  |  动作  |  时间  |  变化  
----  |  ----  |  ----  |  ----  
