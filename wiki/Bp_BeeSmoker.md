...
> 一个使蜜蜂镇定的工具。  
  ...
  熏蜂器  |   图片   
 ----  |  ----:   
 ** 解锁需求: **<br>[蜂箱](BeeSkep.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制造动作](CraftAction.md)  |  <img decoding="async" src="Sprite/BeeSmokerOn.png" href="a.md" style="max-width:300px;max-height:300px;">   
