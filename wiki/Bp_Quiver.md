...
> 可以储存我的箭矢。  
  ...
  箭筒  |   图片   
 ----  |  ----:   
 ** 解锁条件: **<br>[箭术(技能)](Skill_Archery.md): 20-150<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制造动作](CraftAction.md)  |  <img decoding="async" src="Sprite/Quiver.png" href="a.md" style="max-width:300px;max-height:300px;">   
