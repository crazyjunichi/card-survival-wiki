...
> 还是好痛，至少现在伤口缝上了。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**0<br><br>**装备：**[“右腿撕裂伤”](eTag_WLegLacerationR.md)<br><br>**槽位：**1<br><br>**过滤器：**[“敷料”](tag_Dressing.md) , [“止血带”](tag_Tourniquet.md)<br><br>**可使用次数：**0  |  ![](Sprite/LegLacerationStitched.png)   
...
操作  |  值  |  时间  |  变化  
----  |  ----  |  ----  |  ----  
<img decoding="async" src="Sprite/Health.png" style="height:30px;">  |  初始：0<br>最大：2000  |  每天+2<br>最多需要：10天10小时  |  → [已缝合的轻微撕裂伤](W_MinorLacerationStitched.md)  
