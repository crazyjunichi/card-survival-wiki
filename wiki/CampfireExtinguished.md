...
[火炭](Embers.md)  |  添入火炭<br>  |  -  |    |  ** 自身: **<br>燃料  +12(12.5%)<br><img decoding="async" src="Sprite/Charcoal.png" href="a.md" style="max-width:20px;max-height:20px;">  +8(50%)<br><br>** 使用物: **<br>→消失  |    
[椰子皮](CoconutHusk.md)  |  添入椰子皮<br>  |  -  |    |  ** 自身: **<br>燃料  +3(3.13%)<br><br>** 使用物: **<br>→消失  |    
[火种](TinderLit.md)  |  点燃<br>  |  -  |    |  ** 自身: **<br>→ [营火](Campfire.md)<br>燃料  +1(1.04%)<br><br>** 使用物: **<br>→消失  |    
[蒸馏器](AlembicUndeployed.md)  |  放置蒸馏器<br>  |  -  |    |  ** 自身: **<br>→ [蒸馏器(关)](AlembicOff.md)<br>燃料  +2(2.08%)<br><br>** 使用物: **<br>→消失  |    
## 可拖至  
