...
> 一个简单的陷阱。  
  ...
  落石陷阱  |   图片   
 ----  |  ----:   
 ** 解锁条件: **<br>[制作(技能)](Skill_Crafting.md): 10-150<br><br>** 解锁需求: **<br>[大石块](StoneHeavy.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)  |  <img decoding="async" src="Sprite/DeadfallTrap.png" href="a.md" style="max-width:300px;max-height:300px;">   
