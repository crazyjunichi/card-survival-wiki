...
> 似乎是通往洞穴的小型通道。  
  ...
  属性  |   图片   
 ----  |  ----:   
 ** 只允许存在一个 **  |  ![](Sprite/UnderwaterEntrance.png)   
