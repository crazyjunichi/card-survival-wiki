...
> 我可以拿它装水。  
  ...
  葫芦瓶  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“容器（密封）”](tag_ContainerSealed.md), [“皮带”](tag_Belt.md)<br><br>**装备：**[“腰带装备”](eTag_Belt.md)<br><br>**容水量：**600  |  <img decoding="async" src="Sprite/GourdBottle.png" href="a.md" style="max-width:300px;max-height:300px;">   
