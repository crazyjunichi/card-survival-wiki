...
口渴<img decoding="async" src="Sprite/Thirst.png" style="height:30px;">  |  初始：144<br>最大：288  |  每天-1<br>最多需要：3天  |  → [猕猴尸体](MacaqueCarcass.md)  
健康度<img decoding="async" src="Sprite/Health.png" style="height:30px;">  |  初始：288<br>最大：672  |  每天-1<br>最多需要：7天  |  → [猕猴朋友](MacaqueFriend.md)  
