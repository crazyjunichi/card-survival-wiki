...
> 这里似乎连接着另一个洞穴，也许我可以拓宽它。  
  ...
  狭窄通道  |   图片   
 ----  |  ----:   
 ** 不可删除 **<br><br>**环境：**[洞穴底层(区域)](LowChamber.md)  |  <img decoding="async" src="Sprite/CaveCollapsed.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
进度  |  初始：0<br>最大：20  |  -  |  ** 到达上限时： **<br><br>→ [晶石洞穴](CrystalChamberEntrance.md)  
