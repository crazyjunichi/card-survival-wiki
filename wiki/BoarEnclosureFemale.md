...
捡起<br>[手部动作](HandAction.md)  |  30分  |  [光亮](Light.md):10-100  |  → [母猪](BoarTiedFemale.md)<br>压力<img decoding="async" src="Sprite/Content.png" style="width:20px;">  -250<br>  |    
...
Pregnancy Killer  |  ** 需要属性：**<br>BoarEnclosureFemale_SpecialDurability2.CardStatName1～1344  |  怀孕<img decoding="async" src="Sprite/Pregnancy.png" style="width:20px;">：-4  |    
