...
> 我可以把物品储存在里面。  
  ...
  背篓  |   图片   
 ----  |  ----:   
 ** 解锁需求: **<br>[编织篓](Basket.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制造动作](CraftAction.md)  |  <img decoding="async" src="Sprite/BasketBackpack.png" href="a.md" style="max-width:300px;max-height:300px;">   
