...
> 用<b>燧石</b>通过<b>石工</b>技能制成的长矛。<br><br>使用<b>绳子和细线</b>将您的<b>燧石矛头绑在长木棍上</b>。<br><br>它比简易的木制长矛要好得多，可以增加你在与动物战斗时的成功几率。  
  ...
  燧石长矛  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“一级矛”](tag_Spear.md), [“大的”](tag_Large.md)<br><br>**装备：**[“肩部装备”](eTag_Shoulder.md)<br><br>**可使用次数：**75  |  <img decoding="async" src="Sprite/SpearFlint.png" href="a.md" style="max-width:300px;max-height:300px;">   
