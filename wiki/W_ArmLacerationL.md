...
> 一道正在流血的深撕裂伤口，好痛……  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**0<br><br>**标签：**	[“开放性伤口”](tag_OpenWound.md)<br><br>**装备：**[“左臂撕裂伤”](eTag_WArmLacerationL.md)<br><br>**槽位：**1<br><br>**过滤器：**[“敷料”](tag_Dressing.md) , [“止血带”](tag_Tourniquet.md)<br><br>**可使用次数：**0<br><br>** 只允许存在一个 **  |  ![](Sprite/ArmLaceration.png)   
...
Tourniquet  |    |  <img decoding="async" src="Sprite/Health.png" style="width:20px;">：+1<br><img decoding="async" src="Sprite/Bacteria.png" style="width:20px;">：-0.5  |  [皮肤完整度](SkinIntegrity.md)+2<br>[失血](BloodLoss.md)-6<br>[手部神经损伤](NerveDamageHands.md)加成+2  
