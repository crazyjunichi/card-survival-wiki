...
来源  |  操作  
----  |  ----  
[未栽种的农田(空)](CropPlotEmpty.md)  |  种植蜘蛛兰<br>** 拖入：**[蜘蛛兰叶](SpiderLilyLeaves.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
...
成熟度  |  初始：0<br>最大：672  |  每15分钟+1<br>最多需要：7天  |  ** 到达上限时： **<br>** [Result] **<br>  [蜘蛛兰](SpiderLily.md)(+6)<br><br>** 自身 **<br>→消失  
