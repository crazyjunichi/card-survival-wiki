...
> 我可以拿它装水。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“大的”](tag_Large.md), [“粘土”](tag_Clay.md), [“可泼溅的”](tag_Spillable.md), [“容器（敞口）”](tag_ContainerOpen.md), [“沉重的”](tag_Heavy.md)<br><br>**容水量：**1200  |  ![](Sprite/ClayVase.png)   
...
[TestLiquidContainer_CardName](TestLiquidContainer.md)  |  TestLiquidContainer_DismantleActions[1].ActionName  
## 动作  
动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
