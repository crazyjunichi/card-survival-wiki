...
名称  |  条件  |  变化(每15分钟)  |  玩家状态  
----  |  ----  |  ----  |  ----  
Mark  |  ** 需要属性：**<br><img decoding="async" src="Sprite/MindState.png" href="a.md" style="max-width:20px;max-height:20px;">: 1～336(0%～100%)  |    |  [疼痛](Pain.md)+100<br>[压力](Stress.md)加成+2<br>[世界观](Structure.md)加成-1<br>[情绪](Morale.md)加成-1  
