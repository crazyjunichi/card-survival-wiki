...
> 一顶漂亮的帽子，能在一定程度上保护我免受日晒雨淋。<br><br><b>必须装备在装备栏才能生效</b>  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“头部（外层）”](tag_OuterHead.md), [“腿部（内层）”](tag_Clothing.md)<br><br>**装备：**[“头部”](eTag_Head.md)<br><br>**可使用次数：**8640  |  ![](Sprite/HatSurvival.png)   
...
操作  |  值  |  时间  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：8640<br>最大：8640  |  -  |  [布片](ClothSmall.md)1   
