...
> 还是好痛，至少现在伤口缝上了。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **重量：**0<br><br>**装备：**[“大腿撕裂伤”](eTag_WLegLacerationL.md)<br><br>**槽位：**1<br><br>**过滤器：**[“敷料”](tag_Dressing.md) , [“止血带”](tag_Tourniquet.md)<br><br>**可使用次数：**0<br><br>** 只允许存在一个 **  |  ![](Sprite/LegLacerationStitched.png)   
...
Tourniquet  |    |  <img decoding="async" src="Sprite/Health.png" style="width:20px;">：+1<br><img decoding="async" src="Sprite/Bacteria.png" style="width:20px;">：-0.5  |  [皮肤完整度](SkinIntegrity.md)+2<br>[失血](BloodLoss.md)-3<br>[腿部神经损伤](NerveDamageLegs.md)加成+2  
