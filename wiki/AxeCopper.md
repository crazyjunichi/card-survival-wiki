...
> 可以用来砍树。  
  ...
  铜斧  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“锤”](tag_Hammer.md), [“锤”](tag_Axe.md), [“斧状的”](tag_AxeAdv.md)<br><br>**可使用次数：**50  |  ![](Sprite/CopperAxe.png)   
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：50<br>最大：50  |  -  |  ** 到达0时： **<br>[钝斧子头](AxeHeadBlunt.md)+1 <br>[细线](CordFiber.md)+2 <br>[小树枝](Sticks.md)+1   
