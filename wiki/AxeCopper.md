...
> 一种耐用而锋利的铜斧。在损坏后只要把金属部分<b>重新打磨</b>就可以重新做成斧子。<br>你能用它更快地砍伐<b>树木</b>，并制作更复杂的<b>木制品</b>。  
  ...
  铜斧  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“锤”](tag_Hammer.md), [“斧”](tag_Axe.md), [“高级斧”](tag_AxeAdv.md)<br><br>**可使用次数：**50  |  <img decoding="async" src="Sprite/CopperAxe.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：50<br>最大：50  |  -  |  ** 到达0时： **<br>** [Remains]  **<br>  [钝斧子头](AxeHeadBlunt.md)(+1)<br>  [细线](CordFiber.md)(+2)<br>  [小树枝](Sticks.md)(+1)<br>基础权重：1<br>** 自身 **<br>→消失  
