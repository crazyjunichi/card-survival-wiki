...
来源  |  操作  
----  |  ----  
[未栽种的农田(空)](CropPlotEmpty.md)  |  种植柠檬草<br>** 拖入：**[柠檬草](LemongrassStalks.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
...
成熟度  |  初始：0<br>最大：672  |  每15分钟+1<br>最多需要：7天  |  ** 到达上限时： **<br>** [Result] **<br>  [柠檬草](Lemongrass.md)(+12)<br><br>** 自身 **<br>→消失  
...
Dry  |  ** 需要存在卡牌：**<br>[“干燥环境”](tag_EnvDry.md)  |  螨虫侵害<img decoding="async" src="Sprite/Mites.png" href="a.md" style="max-width:20px;max-height:20px;"> +0(0%)<br>成熟度+0.25(0.03%)  |    
...
<script>document.title="柠檬草田 - 卡牌生存百科 Card Survival Wiki";</script>