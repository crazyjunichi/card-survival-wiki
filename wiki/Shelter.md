...
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[棕榈叶](PalmFronds.md)  |  修理窝棚<br>  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>使用次数  +288(50%)<br><br>** 使用物: **<br>→消失  |    
[叶床](LeafBed.md)  |  组合<br>  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>→ [有遮蔽的叶床](ShelteredLeafBed.md)<br>使用次数  +288(50%)<br><br>** 使用物: **<br>→消失  |    
## 属性   
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
