...
> 这张床相对廉价，虽然不舒服，但总比睡在地上好。<br><br>它还提供轻微的<b>避雨和遮阳</b>，也可以与<b>叶床</b>组合，效果更好。  
  ...
  窝棚  |   图片   
 ----  |  ----:   
 **可使用次数：**576<br><br>** 效果: **<br>[雨水防护](RainProtection.md)+2<br>[保温](InsulationCold.md)+5<br>[绝热](InsulationHeat.md)+5<br>[阳光防护](SunProtection.md)+1<br><br>** 区域唯一 **  |  <img decoding="async" src="Sprite/Shelter.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
拆除<br>  |  30分  |  [光亮](Light.md): 10-100  |  消失<br>**  **<br>  [长木棍](StickLong.md)(+3)<br>  [细线](CordFiber.md)(+2)<br>  [棕榈叶](PalmFronds.md)(+1～+4)<br>  |    
## 可拖入  
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
