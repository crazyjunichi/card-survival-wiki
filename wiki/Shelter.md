...
> 这张床相对廉价，虽然不舒服，但总比睡在地上好。<br><br>它还提供轻微的<b>避雨和遮阳</b>，也可以与<b>叶床</b>组合，效果更好。  
  ...
  窝棚  |   图片   
 ----  |  ----:   
 ** 区域唯一 **<br><br>** 不可删除 **<br><br>**可使用次数：**576<br><br>** 效果: **<br>[雨水防护](RainProtection.md)+2<br>[保温](InsulationCold.md)+5<br>[绝热](InsulationHeat.md)+5<br>[阳光防护](SunProtection.md)+1  |  <img decoding="async" src="Sprite/Shelter.png" href="a.md" style="max-width:300px;max-height:300px;">   
...
拆除<br>  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身：**<br>消失<br><br>** 获得： **<br>  [长木棍](StickLong.md)(+3)<br>  [细线](CordFiber.md)(+2)<br>  [棕榈叶](PalmFronds.md)(+1～+4)<br>  |    
## 可拖入  
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[棕榈叶](PalmFronds.md)  |  修理窝棚<br>  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>使用次数 + 288<br><br>** 使用物: **<br>消失  |    
[叶床](LeafBed.md)  |  组合<br>  |  30分  |  [光亮](Light.md): 10-100  |  ** 自身: **<br>→ [有遮蔽的叶床](ShelteredLeafBed.md)<br>使用次数 + 288<br><br>** 使用物: **<br>消失  |    
## 属性   
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：576<br>最大：576  |  每15分钟-1<br>最多需要：6天  |  ** 到达0时： **<br>  [长木棍](StickLong.md)(+3)<br>  [细线](CordFiber.md)(+2)<br>  
