...
> <b>必须装备在装备栏才能生效</b>  
  ...
  布制裤子  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**装备时减重：**-100<br><br>**标签：**	[“腿部（内层）”](tag_InnerLegs.md), [“腿部（外层）”](tag_OuterLegs.md), [“腿部（内层）”](tag_Clothing.md)<br><br>**装备：**[“裤子”](eTag_Pants.md)<br><br>**可使用次数：**2400<br><br>** 效果: **<br>[体感温度](TemperaturePerceived.md)+0.5<br>[阳光防护](SunProtection.md)+0.5<br>[世界观](Structure.md)加成+0.1  |     
  
## 获取来源  
来源  |  操作  
----  |  ----  
[腿部（内层）(蓝图)](InnerLegsBlueprint.md)  |  制作布制裤子<br>** 拖入：**[大块的布](ClothLarge.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
