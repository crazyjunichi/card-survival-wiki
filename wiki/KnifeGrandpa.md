...
> 一把小刀，可用于切割或刺穿东西。<br>变钝后可被再次打磨锋利。  
  ...
  祖父的刀  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“刮具”](tag_Scraper.md), [“切割工具”](tag_Cutter.md), [“高级切割工具”](tag_CutterAdv.md), [“锤”](tag_Hammer.md), [“沉重的”](tag_Heavy.md), [“美丽的/好看的”](tag_Pretty.md)<br><br>**可使用次数：**40  |  <img decoding="async" src="Sprite/GrandfathersDagger.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[祖父的刀](KnifeGrandpa.md)  |  磨利<br>** 拖入：**[石头](Stone.md) , [大石块](StoneHeavy.md) , [硫磺石](StoneHeavyBrimstone.md)  
[祖父的钝刀](KnifeGrandpaBlunt.md)  |  磨利<br>** 拖入：**[石头](Stone.md) , [大石块](StoneHeavy.md) , [硫磺石](StoneHeavyBrimstone.md)  
## 可拖入  
使用  |  动作  |  耗时  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
[石头](Stone.md)<br>[大石块](StoneHeavy.md)<br>[硫磺石](StoneHeavyBrimstone.md)  |  磨利<br>[手部动作](HandAction.md)  |  30分  |    |  ** 自身: **<br>→ [祖父的刀](KnifeGrandpa.md)<br><br>** 使用物: **<br>可用次数  -1  |    
## 可拖至  
