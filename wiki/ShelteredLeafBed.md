...
操作  |  值  |  时间  |  变化  
----  |  ----  |  ----  |  ----  
<img decoding="async" src="Sprite/SnakeGrass.png" style="height:30px;">  |  初始：600<br>最大：600  |  每天-1<br>最多需要：6天6小时  |  → [窝棚](Shelter.md)  
<img decoding="async" src="Sprite/PalmTreeLeaves.png" style="height:30px;">  |  初始：576<br>最大：576  |  每天-1<br>最多需要：6天  |  [长木棍](StickLong.md)3 <br><br>[细线](CordFiber.md)2 <br><br>→ [叶床](LeafBed.md)  
