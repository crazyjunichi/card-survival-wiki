...
屋顶破洞计数  |  初始：0<br>最大：96  |  每15分钟+0.1<br>最多需要：10天  |  ** 到达上限时： **<br>** [Result]  **<br>  [屋顶损坏](Dmg_RoofDamage.md)(+1)<br><br>** 自身 **<br>屋顶破洞计数  -96(-100%)<br>屋顶坍塌计数  +1(25%)  
屋顶坍塌计数  |  初始：0<br>最大：4  |  -  |  ** 到达上限时： **<br>  [坍塌的屋顶(泥屋)](Dmg_RoofCollapsed.md)(+1)<br><br>** 自身 **<br>屋顶坍塌计数  -4(-100%)  
## 被动效果  
名称  |  条件  |  变化(每15分钟)  |  玩家状态  
----  |  ----  |  ----  |  ----  
