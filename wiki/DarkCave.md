...
> 幽暗、潮湿、可怕的洞穴。  
  ...
  属性  |   图片   
 ----  |  ----:   
 **标签：**	[“室内”](tag_EnvIndoors.md)<br><br>** 只允许存在一个 **  |  ![](Sprite/CaveEntrance.png)   
...
动作  |  时间  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
探索<br>  |  15分  |  [光亮](Light.md):5-100  |  [石头](Stone.md)(+1)<br>基础权重：10<br><br>[虫子](Bugs.md)(+3)<br>基础权重：4<br>  |  [污垢](Filth.md)+2  
## 可拖入  
使用  |  动作  |  时间  |  条件  |  变化  |  玩家状态  
----  |  ----  |  ----  |  ----  |  ----  |  ----  
