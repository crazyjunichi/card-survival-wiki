...
> 用于制造铜斧的模具。  
  ...
  斧头模具  |   图片   
 ----  |  ----:   
 ** 解锁需求: **<br>[铜](Copper.md)<br><br>** 动作分类: **<br>[手部动作](HandAction.md)<br>[制造动作](CraftAction.md)  |  <img decoding="async" src="Sprite/MoldAxe.png" href="a.md" style="max-width:300px;max-height:300px;">   
