...
>   
  ...
  马勃菌菌床  |   图片   
 ----  |  ----:   
 **标签：**	[“农作物”](tag_Crop.md)<br><br>**可使用次数：**0<br><br>** 效果: **<br>[不适](Discomfort.md)+300  |  <img decoding="async" src="Sprite/MushroomBedPuffballs.png" href="a.md" style="max-width:300px;max-height:300px;">   
