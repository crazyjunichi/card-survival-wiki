...
来源  |  操作  
----  |  ----  
[未栽种的农田(空)](CropPlotEmpty.md)  |  种植椰子树<br>** 拖入：**[椰子](Coconut.md) , [青椰子](CoconutHusked.md)  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
...
成熟度  |  初始：0<br>最大：672  |  每15分钟+0.5<br>最多需要：14天  |  ** 到达上限时： **<br>** [Result] **<br>  [幼年椰子树](PalmTreeYoung.md)(+1)<br><br>** 自身 **<br>→消失  
...
Humid  |  ** 需要存在卡牌：**<br>[“潮湿环境”](tag_EnvHumid.md)  |  成熟度-0.25(-0.04%)<br>含水量+0.75  |    
...
<script>document.title="椰子树田 - 卡牌生存百科 Card Survival Wiki";</script>