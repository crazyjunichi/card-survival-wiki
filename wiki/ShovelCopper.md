...
> 这会是很棒的挖掘工具。  
  ...
  铜铲  |   图片   
 ----  |  ----:   
 **重量：**250<br><br>**标签：**	[“锤”](tag_Hammer.md), [“铲子”](tag_Shovel.md), [“沉重的”](tag_Heavy.md)<br><br>**可使用次数：**50  |  ![](Sprite/CopperShovel.png)   
...
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
拆解<br>  |  15分  |    |  消失<br>[铲子头](ShovelHead.md)(+1)<br>[细线](CordFiber.md)(+1)<br>  |    
## 可拖至  
...
属性  |  值  |  耗时  |  变化  
----  |  ----  |  ----  |  ----  
使用次数  |  初始：50<br>最大：50  |  -  |  ** 到达0时： **<br>[铲子头](ShovelHead.md)+1 <br>[细线](CordFiber.md)+2 <br>[小树枝](Sticks.md)+1   
