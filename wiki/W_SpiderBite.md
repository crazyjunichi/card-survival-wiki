...
名称  |  条件  |  变化(每15分钟)  |  玩家状态  
----  |  ----  |  ----  |  ----  
Dressing (weak)  |  ** 需要存在卡牌：**<br>[叶片绷带](LeafDressing.md)<br>[临时绷带](ImprovisedDressing.md)  |  <img decoding="async" src="Sprite/Health.png" style="width:20px;">+1<br><img decoding="async" src="Sprite/Bacteria.png" style="width:20px;">-0.5  |  [皮肤完整度](SkinIntegrity.md)+1  
Dressing (strong)  |  ** 需要存在卡牌：**<br>[伤口敷料](WoundDressing.md)<br>[草木灰敷料](AshDressing.md)  |  <img decoding="async" src="Sprite/Health.png" style="width:20px;">+1.5<br><img decoding="async" src="Sprite/Bacteria.png" style="width:20px;">-1  |  [皮肤完整度](SkinIntegrity.md)+1  
