...
<br>  
> 一个便携的密封容器，可以背在<b>肩膀</b>上，能够储存3份的<b>水</b>。<br><br>它可以用<b>鞣制兽皮、脂肪、细线和针</b>制作。  
  
  水袋  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**装备时减重：**-100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“挎包”](tag_Satchel.md), [“容器（密封）”](tag_ContainerSealed.md)<br><br>**装备：**[“肩部装备”](eTag_Shoulder.md)<br><br>**储水量：**900  |  <img decoding="async" src="Sprite/WaterSkin.png" href="a.md" style="max-width:300px;max-height:300px;">   
  
## 获取来源  
来源  |  操作  
----  |  ----  
[水袋(蓝图)](Bp_Waterskin.md)  |  蓝图制造  
## 动作  
动作  |  耗时  |  条件  |  变化  |  状态  
----  |  ----  |  ----  |  ----  |  ----  
