...
> 我可以拿它装水。  
  ...
  水壶  |   图片   
 ----  |  ----:   
 **重量：**100<br><br>**标签：**	[“储水容器”](tag_WaterContainer.md), [“军用的”](tag_Military.md), [“容器（密封）”](tag_ContainerSealed.md)<br><br>**储水量：**600  |  <img decoding="async" src="Sprite/MilitaryCanteen.png" href="a.md" style="max-width:300px;max-height:300px;">   
