...
<style>
        ...
        </style><table class="table table-bordered table4834" data-toggle="table"  ><thead style=""><tr ><th  style=""  >名称</th><th  style=""  >条件</th><th  style=""  >变化</th></tr></thead><tr ><td  style=""  >猕猴灭绝</td><td  style=""  >[猕猴种群数量](Pop_Macaque.md): <span style="font-family:ui-monospace"><b>0-1999</b></span></td><td  style=""  >→ [<div style="width:20px;display:inline-block;text-align:center"><img decoding="async" src="../wiki/Sprite/DarkCaveEntrance.png" href="a.md" style="max-width:20px;max-height:20px;"></div>[猕猴窝(空)](MacaqueDenEntranceClear.md)](MacaqueDenEntranceClear.md)</td></tr></tbody></table>  
